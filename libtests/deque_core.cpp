...
template <int tValue>
const int Log2<tValue>::kLowerLog = pradeque_detail::LowerLog2(tValue);
...
{
	EXPECT_EQ(PRA_DEQUE_LOWER_LOG2_UINT64(2000 ? 7 : 2000), 2);
	EXPECT_EQ(-PRA_DEQUE_LOWER_LOG2_UINT64(0x80), -7);
}
