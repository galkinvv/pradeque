...
struct Log2
{
	...
	static const int kUpperLog =tValue ==1 ? 0 : PRA_DEQUE_LOWER_LOG2_UINT64_DETAILV1(tValue - 1)+1;
	static int LowerLog(){return kLowerLog;}
	static int UpperLog(){return kUpperLog;}
};
...
TEST(zero_count, macro_via_class)
{
