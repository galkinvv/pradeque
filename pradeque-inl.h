...
#define PRA_DEQUE_LOW_ZEROES_COMBINE_SUBRESULTS_DETAILV1(zerocount_xlow, zerocount_xhigh, x, halfxbits) ((0 == (x & ~((~0ull) << halfxbits))) ? zerocount_xhigh + halfxbits : zerocount_xlow )

//All functions gaurantee meaningful result only for non-zero x
#define PRA_DEQUE_LOW_ZEROES_x02_DETAILV1(x) (x == 2)

#define PRA_DEQUE_LOW_ZEROES_x04_DETAILV1(x) PRA_DEQUE_LOW_ZEROES_COMBINE_SUBRESULTS_DETAILV1(PRA_DEQUE_LOW_ZEROES_x02_DETAILV1((x & 0x0000000000000003ull)), PRA_DEQUE_LOW_ZEROES_x02_DETAILV1((x >> 0x02)), x, 0x02)
#define PRA_DEQUE_LOW_ZEROES_x08_DETAILV1(x) PRA_DEQUE_LOW_ZEROES_COMBINE_SUBRESULTS_DETAILV1(PRA_DEQUE_LOW_ZEROES_x04_DETAILV1((x & 0x000000000000000Full)), PRA_DEQUE_LOW_ZEROES_x04_DETAILV1((x >> 0x04)), x, 0x04)
#define PRA_DEQUE_LOW_ZEROES_x10_DETAILV1(x) PRA_DEQUE_LOW_ZEROES_COMBINE_SUBRESULTS_DETAILV1(PRA_DEQUE_LOW_ZEROES_x08_DETAILV1((x & 0x00000000000000FFull)), PRA_DEQUE_LOW_ZEROES_x08_DETAILV1((x >> 0x08)), x, 0x08)
#define PRA_DEQUE_LOW_ZEROES_x20_DETAILV1(x) PRA_DEQUE_LOW_ZEROES_COMBINE_SUBRESULTS_DETAILV1(PRA_DEQUE_LOW_ZEROES_x10_DETAILV1((x & 0x000000000000FFFFull)), PRA_DEQUE_LOW_ZEROES_x10_DETAILV1((x >> 0x10)), x, 0x10)
#define PRA_DEQUE_LOW_ZEROES_x40_DETAILV1(x) PRA_DEQUE_LOW_ZEROES_COMBINE_SUBRESULTS_DETAILV1(PRA_DEQUE_LOW_ZEROES_x20_DETAILV1((x & 0x00000000FFFFFFFFull)), PRA_DEQUE_LOW_ZEROES_x20_DETAILV1((x >> 0x20)), x, 0x20)
